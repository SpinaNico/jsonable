...
Iterable<List<T>> zip<T>(List<Iterable> iterables) sync* {
  ...
  while (iterators.every((e) => e.moveNext())) {
    yield iterators.map((e) => e.current).toList(growable: false) as List<T>;
  }
}
...
class CJlist<E> extends JList<E?> {
  ...
  E? firstWhere(bool Function(E? element) test, {Function()? orElse}) =>
      _elements!.firstWhere(test, orElse: orElse as E? Function()?);
  ...
  lastWhere(bool Function(E? element) test, {Function()? orElse}) =>
      _elements!.lastWhere(test, orElse: orElse as E? Function()?);
  ...
  @override
  E? reduce(Function(E value, E element) combine) => _elements!.reduce(combine as E? Function(E?, E?));
  E? get single => _elements!.single;
  E? singleWhere(bool Function(E? element) test, {Function()? orElse}) =>
      _elements!.singleWhere(test, orElse: orElse as E? Function()?);
  ...
  List<E?> operator +(Object other) {
    if (other is List<E> || other is JList<E>) {
      return List.from(_elements!) + List.from(other as Iterable<dynamic>) as List<E?>;
    }
    return _elements! + (other as List<E?>);
  }
